######################################################################################
######################################################################################
#### BDB 2025 preprocessing: pre snap new (at line set) with y ordering
######################################################################################
######################################################################################
...
tracking_reorder = trackingList[-c(out1,out2)] %>% 
...
trackingWide = tracking_reorder %>%
  select(-off_def,-initial_y,-position, -isFootball,-displayName_fac,
         -s,-a,-dis,-displayName,-jerseyNumber,-club) %>% 
...
saveRDS(tw_full,"data/w12_y_ord.rds")
saveRDS(tw_full,"data/w34_y_ord.rds")
saveRDS(tw_full,"data/w56_y_ord.rds")
saveRDS(tw_full,"data/w78_y_ord.rds")
saveRDS(tw_full,"data/w9_y_ord.rds")
